...
if($r)
{
   echo "<table class='table-fill'>"; 
        ...
        echo "<thead>";
        echo "<tr >";
        echo "<th class='text-left' > LOGO</th>"; 
        echo "<th class='text-left' > Party Name </th>"; 
        echo "<th class='text-left' > Total Vote</th>"; 
        echo "</tr>"; 
        echo "</thead>";
   ...
   while($row=mysqli_fetch_array($r))
   {
        ...
        echo "<tr>";
         ...
         echo "<td  class='text-left'>" . $row['partyname'] . "</td>"; 
          ...
          $query = "SELECT COUNT(vote) FROM androidotp WHERE vote='$partyname'";
          $result = mysqli_query($con,$query);
          $roww=mysqli_fetch_array($result);
          

        echo "<td class='text-left' >" .$roww['COUNT(vote)']. "</td>";
